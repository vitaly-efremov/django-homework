...
class Statistics(object):
    def __init__(self, subjects, students, scores):
        ...
        self.bad_students = ', '.join(student['fio'] for student in self.statistics if student['average'] <= 3)
...
scores = [Score(student, subject, int(random()*4)+2) for subject in subjects for student in students]
